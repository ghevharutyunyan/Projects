...
static constexpr auto qt_meta_stringdata_ZN11CoinControlE = QtMocHelpers::stringData(
    "CoinControl",
    "favoritesUpdated",
    "",
    "for_general",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11CoinControlE[] = {
...
Q_CONSTINIT const QMetaObject CoinControl::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11CoinControlE.offsetsAndSizes,
    qt_meta_data_ZN11CoinControlE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11CoinControlE_t,
        // Q_OBJECT / Q_GADGET
...
void CoinControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (CoinControl::*)();
            if (_q_method_type _q_method = &CoinControl::favoritesUpdated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (CoinControl::*)(const QList<CryptoData> & );
            if (_q_method_type _q_method = &CoinControl::for_general; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *CoinControl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11CoinControlE.stringdata0))
