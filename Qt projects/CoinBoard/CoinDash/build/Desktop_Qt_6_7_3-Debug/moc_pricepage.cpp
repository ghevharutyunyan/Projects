...
struct qt_meta_stringdata_CLASSPricePageENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPricePageENDCLASS = QtMocHelpers::stringData(
    "PricePage"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPricePageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PricePage::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPricePageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPricePageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPricePageENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *PricePage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPricePageENDCLASS.stringdata0))
