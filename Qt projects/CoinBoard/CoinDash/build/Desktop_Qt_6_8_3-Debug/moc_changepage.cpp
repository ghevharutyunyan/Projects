...
static constexpr auto qt_meta_stringdata_ZN10ChangePageE = QtMocHelpers::stringData(
    "ChangePage"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10ChangePageE[] = {
...
Q_CONSTINIT const QMetaObject ChangePage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10ChangePageE.offsetsAndSizes,
    qt_meta_data_ZN10ChangePageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10ChangePageE_t,
        // Q_OBJECT / Q_GADGET
...
void *ChangePage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10ChangePageE.stringdata0))
