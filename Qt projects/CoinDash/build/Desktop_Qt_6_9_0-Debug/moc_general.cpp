...
template <> constexpr inline auto General::qt_create_metaobjectdata<qt_meta_tag_ZN7GeneralE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'onDataReady'
        QtMocHelpers::SlotData<void(const QList<CryptoData> &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
    ...
    return QtMocHelpers::metaObjectData<General, qt_meta_tag_ZN7GeneralE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
void *General::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7GeneralE_t>.strings))
