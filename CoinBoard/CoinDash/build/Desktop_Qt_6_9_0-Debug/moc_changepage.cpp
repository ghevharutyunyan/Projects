...
namespace {
struct qt_meta_tag_ZN10ChangePageE_t {};
} // unnamed namespace

template <> constexpr inline auto ChangePage::qt_create_metaobjectdata<qt_meta_tag_ZN10ChangePageE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<ChangePage, qt_meta_tag_ZN10ChangePageE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject ChangePage::staticMetaObject = { {
    QMetaObject::SuperData::link<BasePage::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10ChangePageE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10ChangePageE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10ChangePageE_t>.metaTypes,
    nullptr
} };
...
void *ChangePage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10ChangePageE_t>.strings))
