...
static constexpr auto qt_meta_stringdata_ZN8BasePageE = QtMocHelpers::stringData(
    "BasePage"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8BasePageE[] = {
...
Q_CONSTINIT const QMetaObject BasePage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8BasePageE.offsetsAndSizes,
    qt_meta_data_ZN8BasePageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8BasePageE_t,
        // Q_OBJECT / Q_GADGET
...
void *BasePage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8BasePageE.stringdata0))
